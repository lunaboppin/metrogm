...
AddCSLuaFile("metrostroi_vendor_autorun/metrostroi.lua")
AddCSLuaFile("metrostroi_vendor_autorun/prop_button.lua")
AddCSLuaFile("metrostroi_vendor_autorun/prop_float_ex.lua")
