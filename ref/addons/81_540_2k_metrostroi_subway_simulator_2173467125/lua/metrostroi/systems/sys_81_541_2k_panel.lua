...
--------------------------------------------------------------------------------
Metrostroi.DefineSystem("81_541_2k_Panel")
...
function TRAIN_SYSTEM:Outputs()
    return { "V1", "EmergencyLights","MainLights","DoorsW","GreenRP","BrW","TW18","L1","M1_3","M4_7","M8","AnnouncerPlaying","AnnouncerBuzz","PCBKPower","RZP","LZBP"}
end
