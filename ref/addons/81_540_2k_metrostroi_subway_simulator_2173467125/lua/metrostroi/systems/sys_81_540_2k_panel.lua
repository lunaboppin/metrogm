--------------------------------------------------------------------------------
-- Панель для 81-540.2К
--------------------------------------------------------------------------------
Metrostroi.DefineSystem("81_540_2k_Panel")

function TRAIN_SYSTEM:Initialize()
    self.Train:LoadSystem("VB","Relay","Switch",{bass = true})
    self.Train:LoadSystem("UNBDK","Relay","Switch", {bass = true,normally_closed=true})
    self.Train:LoadSystem("VIS","Relay","VA21-29")
    self.Train:LoadSystem("UnBlockDoor","Relay","Switch", {bass = true})
    ...
    self.Train:LoadSystem("ARSM","Relay","Switch", {bass = true, normally_closed = true})
    self.Train:LoadSystem("ARSR","Relay","Switch", {bass = true})
    self.Train:LoadSystem("UOS","Relay","Switch", {bass = true})
    self.Train:LoadSystem("Pred1B","Relay","VA21-29", {bass = true})
    self.Train:LoadSystem("Pred2B","Relay","VA21-29", {bass = true})
    self.Train:LoadSystem("A82","Relay","VA21-29", {bass = true})
    self.Train:LoadSystem("Omivatel","Relay","Switch", {bass = true})
    self.Train:LoadSystem("VP","Relay","Switch", {bass = true})--Omivatel
    self.Train:LoadSystem("OHSteklo","Relay","Switch", {bass = true})--Omivatel
    self.Train:LoadSystem("OHMirror","Relay","Switch", {bass = true})--Omivatel
    self.Train:LoadSystem("Svet","Relay","Switch", {bass = true})
    self.Train:LoadSystem("ALSFreq","Relay","Switch",{bass=true})--SAB1ToggleSwitch
    self.Train:LoadSystem("SAB1ToggleSwitch","Relay","Switch",{maxvalue=2,defaultvalue=1,bass=true})
    self.Train:LoadSystem("ALS","Relay","Switch", {bass = true,normally_closed=true})
    self.Train:LoadSystem("ALSToggleSwitch","Relay","Switch",{maxvalue=2,defaultvalue=1,bass=true})
    self.Train:LoadSystem("StekloOchSwitch","Relay","Switch",{maxvalue=2,defaultvalue=0,bass=true})
    self.Train:LoadSystem("KRUSwitch","Relay","Switch",{maxvalue=2,defaultvalue=0,bass=true})
    self.Train:LoadSystem("YarkostToggleSwitch","Relay","Switch",{maxvalue=2,defaultvalue=1,bass=true})
    self.Train:LoadSystem("VVToggleSwitch","Relay","Switch",{maxvalue=4,defaultvalue=1,bass=true})
    self.Train:LoadSystem("VV1ToggleSwitch","Relay","Switch",{maxvalue=4,defaultvalue=1,bass=true})
    ...
    self.Train:LoadSystem("R_ASNPOn","Relay","Switch", {bass = true})
    ...
    self.Train:LoadSystem("MirrorO","Relay","Switch",{ bass = true})
    self.Train:LoadSystem("HeadO","Relay","Switch",{bass = true })
    ...
    self.Train:LoadSystem("A83","Relay","VA21-29")
    ...
    self.Train:LoadSystem("KRZK","Relay","Switch", { bass = true,normally_closed = true })
    ...
    -- upd: резервный блок питания
    self.Train:LoadSystem("RezBPSNon","Relay","Switch", { bass = true })
    self.Train:LoadSystem("VN","Relay","Switch", { bass = true })
...
function TRAIN_SYSTEM:Outputs()
    return { "V1","LUDS","RedLight2","RedLight1","Headlights1","Headlights2","DR1","DR2","EqLights","CabLights","EqLights","PanelLights","CabinLight","EmergencyLights","MainLights","DoorsLeft","DoorsRight","DoorsW","GreenRP","BrW","AVU","LKVP","BPError","RZP","KUP","BrT","LSN","Ring","SD","LST","LVD","LhRK","KVC","SD","TW18", "KT",
             "LKVD","LN","RS","AR04","AR0","AR40","AR60","AR70","AR80","L1","M1_3","M4_7","M8",
             "AnnouncerPlaying","AnnouncerBuzz","VPR",
             "CBKIPower","PCBKPower","LZBP"}
end
TRAIN_SYSTEM.AVMap = {
