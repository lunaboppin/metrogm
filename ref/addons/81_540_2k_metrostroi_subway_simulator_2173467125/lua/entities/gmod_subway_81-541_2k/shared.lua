...
ENT.PrintName = "81-714.5М (Пришелец промежуточный)"
ENT.Author          = ""
ENT.Contact         = ""
ENT.Purpose         = ""
ENT.Instructions    = ""
...
function ENT:InitializeSystems()
    -- Электросистема 81-541
    self:LoadSystem("Electric","81_541_2k_Electric")
    ...
    -- self:LoadSystem("UFD","81_540_2k_ufdalpha") 
    self:LoadSystem("IGLA_PCBK")
    -- Панель управления 81-710
    self:LoadSystem("Panel","81_541_2k_Panel")
    -- Пневмосистема 81-710
    self:LoadSystem("Pneumatic","81_540_2k_Pneumatic",{br013_1 = true})
