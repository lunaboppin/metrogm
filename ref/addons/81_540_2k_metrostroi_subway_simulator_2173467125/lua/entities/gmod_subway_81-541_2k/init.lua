...
function ENT:TrainSpawnerUpdate()
    ...
    self:SetNW2String("Texture","Default5402kkiev")
...
function ENT:Think()
    ...
    self.BlockDoorR = self:ReadTrainWire(102)*(self.RearDoor and 0 or 1) 
    self.BlockDoorL = self:ReadTrainWire(102)*(self.FrontDoor and 0 or 1) 
...
function ENT:OnButtonPress(button,ply)
    if button == "FrontDoor" and self.BlockDoorL ~= 1 then 
        self.FrontDoor = not self.FrontDoor 
    end
    if button == "RearDoor" and self.BlockDoorR ~= 1 then 
