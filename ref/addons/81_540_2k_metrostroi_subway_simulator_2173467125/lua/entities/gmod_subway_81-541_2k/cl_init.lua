...
ENT.ClientSounds = {}
ENT.AutoAnims = {}
ENT.ClientProps["2k_int_otsav_rem"] = {
    model = "models/metrostroi_train/81-5402/2k_int_otsav_rem.mdl",
    pos = Vector(0,0,0),
    ang = Angle(0,-90,0),
    hide=2,
    scale = 1,
...
ENT.ClientProps["salon"] = {
    model = "models/2k_int/2k_interior_mvm_int.mdl",
    pos = Vector(0,0,0),
    ang = Angle(0,0,0),
    hide=2,
}
...
ENT.ClientProps["door1"] = {
    model = "models/metrostroi_train/81-5402/door_torec_2k_714.mdl",
    pos = Vector(459.2,-15.6,-2.5),
    ang = Angle(0,89.5,0),
    hide=2,
}
...
ENT.ClientProps["door3x1"] = {
    model = "models/2k_int/2k_doors.mdl",
    pos = Vector(-350.3+0.8-2.2,65.164,0.9),
    ang = Angle(0,0,0),
    hide = 2.0,
}
ENT.ClientProps["door0x0"] = {
    model = "models/2k_int/2k_doors.mdl",
    pos = Vector(337.2+1.2,-65.164,0.807),
    ang = Angle(0,180,0),
    hide = 2.0,
}
...
ENT.ClientProps["lamp1_13"] = {
    model = "models/2k_int/2k_emissive.mdl",
    pos = Vector(333.949 - 33.5*-1.065,0,69.7),
    ang = Angle(0,0,0),
...
function ENT:Think()
    ...
    self:ShowHide("seats_new_cap_o",capOpened)
    self:ShowHide("seats_new_cap",not capOpened) 
    self:ShowHide("2k_int_otsav_rem",capOpened)
