...
ENT.PrintName		= "81-761 MVM"
ENT.Author          = ""
ENT.Contact         = ""
ENT.Purpose         = ""
ENT.Instructions    = ""
ENT.Category		= "Metrostroi (trains)"
--ENT.SkinsType = "81-760"
ENT.Model = "models/metrostroi_train/81-760/81_761_body.mdl"
...
function ENT:InitializeSounds()
    ...
    self.SoundPositions["pneumo_TL_open"] = {60,1e9,Vector(437.6, -54.5 ,-47),0.7}
    self.SoundPositions["pneumo_TL_disconnect"] = {60,1e9,Vector(437.6, -54.5 ,-47),0.7}
	
    self.SoundNames["pneumo_BL_open"] = {
        "subway_trains/ezh3/pneumatic/brake_line_on2.mp3",
    }
    self.SoundNames["pneumo_BL_disconnect"] = {
        "subway_trains/common/334/334_close.mp3",
    }
    self.SoundPositions["pneumo_BL_open"] = {60,1e9,Vector(444.95,-52.6,-44.8),0.7}
    self.SoundPositions["pneumo_BL_disconnect"] = {60,1e9,Vector(444.95,-52.6,-44.8),0.7}

    self.SoundNames["pneumo_brake_open"] = {
        "subway_trains/ezh3/pneumatic/brake_line_on.mp3",
    }
    self.SoundNames["pneumo_brake_disconnect"] = {
        "subway_trains/common/switches/pneumo_disconnect_switch.mp3"
    }
    self.SoundPositions["pneumo_brake_open"] = {60,1e9,Vector(435.1,-60.7,-26.65),0.7}
    self.SoundPositions["pneumo_brake_disconnect"] = {60,1e9,Vector(435.1,-60.7,-26.65),0.7}
	...
	self.SoundNames["door_cab_f_open"] = self.SoundNames["door_cab_open"]
	self.SoundPositions["door_cab_f_open"] = {800,1e9,Vector(462,-17,-10),0.5}
	self.SoundNames["door_cab_f_close"] = self.SoundNames["door_cab_close"]
	self.SoundPositions["door_cab_f_close"] = {800,1e9,Vector(462,-17,-10),0.5}
	self.SoundNames["door_cab_b_open"] = self.SoundNames["door_cab_open"]
	self.SoundPositions["door_cab_b_open"] = {800,1e9,Vector(-466.2,17,-10),0.5}
	self.SoundNames["door_cab_b_close"] = self.SoundNames["door_cab_close"]
	self.SoundPositions["door_cab_b_close"] = {800,1e9,Vector(-466.2,17,-10),0.5}	
...
function ENT:InitializeSystems()
	...
	self:LoadSystem("BUV","81_760_BUV")	

	self:LoadSystem("Pneumatic","81_760_Pneumatic")

	self:LoadSystem("Panel","81_761_Panel")
...
function ENT:PostInitializeSystems()
	self.Pneumatic:TriggerInput("DisconnectType",1)
	self.Pneumatic:TriggerInput("MaxPosition",1)	
