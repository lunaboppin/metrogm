...
-- Панель управления 
--------------------------------------------------------------------------------
Metrostroi.DefineSystem("81_760_Panel")
...
function TRAIN_SYSTEM:Initialize()
	...
	self.Train:LoadSystem("CISRestart","Relay","Switch",{bass=true})
	self.Train:LoadSystem("CISRestartK","Relay","Switch",{defaultvalue=1,bass=true})
...
function TRAIN_SYSTEM:Outputs()
	return { "Controller","AnnouncerPlaying","TargetController",
			...
			"EmerBrakeL","EmerXodL","KAHl","ALSl","PRl","OtklRl","R_Linel","R_ChangeRoutel","Washerl","Wiperl","EmergencyControlsl","EmergencyDoorsl","GlassHeatingl",
