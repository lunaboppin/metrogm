Metrostroi.DefineSystem("81_760_RVS_1")
...
if SERVER then
	function TRAIN_SYSTEM:Trigger(name,value)
		...
		local Power = (Train.Electric.Battery80V > 62 or Train.SA10.Value > 0.5) and Train.SF21.Value > 0.5
	...
	function TRAIN_SYSTEM:Think(dT)
		local Train = self.Train
		local Power = (Train.Electric.Battery80V > 62 or Train.SA10.Value > 0.5) and self.Power and Train.SF21.Value > 0.5
