...
ENT.SyncTable = {
    ...
    "VZ1","VUD1","KDL","KDLK_mpl","KDLK_pbl","KDP","KDPK_mpl","KDPK_pbl","KRTD","KRTDK","DoorSelect",
    ...
    "ASPS_RestartSetK","ASPS_Restart","ASPS_View","ASPS_Esc",
}
...
function ENT:Think()
    ...
    if self:GetNW2Int("AVType")<=2 then
        ...
        self:SetPackedBool("PUK16",self.PUAV.LK16 > 0)
        self:SetPackedBool("PUOS",self.PUAV.LOS > 0)
        self:SetPackedBool("PUAVT",self.PUAV.LAVT > 0)
        self:SetPackedBool("PULRS",self.PUAV.LRS > 0)
        self:SetPackedBool("PUKI1",self.PUAV.LKI1 > 0)
        self:SetPackedBool("PUKI2",self.PUAV.LKI2 > 0)
    ...
    self:SetPackedBool("Buzzer",self.Panel.Ring+self.ALS_ARS.Ring > 0)
...
function ENT:OnButtonPress(button,ply)
    ...
    if button == "OtsekDoor1" then self.OtsekDoor1 = true end
    if button == "OtsekDoor1O" then self.OtsekDoor1 = false end
