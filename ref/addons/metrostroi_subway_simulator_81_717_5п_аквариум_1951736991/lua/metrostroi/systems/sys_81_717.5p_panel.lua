--------------------------------------------------------------------------------
-- 81-717.5P SPB controller panel
--------------------------------------------------------------------------------
Metrostroi.DefineSystem("81_717.5P_Panel")
...
function TRAIN_SYSTEM:Initialize()
	...
	self.Train:LoadSystem("VMKSwitch","Relay","Switch",{maxvalue=2,defaultvalue=1,bass=true})
	...
	self.Train:LoadSystem("KRTD","Relay","Switch", {bass = true})
    ...
    self.Train:LoadSystem("KDLK_mpl","Relay","Switch", { bass = true,normally_closed = true })
	self.Train:LoadSystem("KDLK_pbl","Relay","Switch", { bass = true,normally_closed = true })
    self.Train:LoadSystem("KDLRK","Relay","Switch", { bass = true,normally_closed = true })
    self.Train:LoadSystem("KDPK_mpl","Relay","Switch", { bass = true,normally_closed = true })
	self.Train:LoadSystem("KDPK_pbl","Relay","Switch", { bass = true,normally_closed = true })
	self.Train:LoadSystem("ASPS_RestartSetK","Relay","Switch", { bass = true,normally_closed = true })
	self.Train:LoadSystem("KRTDK","Relay","Switch", { bass = true,normally_closed = true })
	...
	self.Train:LoadSystem("BPSNSwitch","Relay","Switch",{maxvalue=2,defaultvalue=1,bass=true})
    self.Train:LoadSystem("HeadLightsSwitch","Relay","Switch",{maxvalue=2,defaultvalue=1,bass=true})
    ...
    self.Train:LoadSystem("PVK","Relay","Switch",{bass=true})
...
function TRAIN_SYSTEM:Outputs()
    return { "V1","LUDS","RedLight2","LMK","LMKR","VZ1L","VZ2L","KRUL","RedLight1","Headlights1","Headlights2","EqLights","CabLights","EqLights","PanelLights","CabinLight","EmergencyLights","MainLights","DoorsLeft","DoorsRight","DoorsW","GreenRP","BrW","AVU","LKVP","LKVPR","RZP","KUP","BrT","LSN","Ring","SD","LST","LKVD","LVD","LhRK","KVC","SD","TW18","KT","OhrSig","SOSD","AnnouncerPlaying","AnnouncerBuzz","UPOPower","M8","VPR","BURPower","RVSLight","KNL","PTK","NMLow","ABLow","UAVATriggered" }
end
