--------------------------------------------------------------------------------
-- 81-717.5P route number
--------------------------------------------------------------------------------
Metrostroi.DefineSystem("81-717.5P_RouteNumber")
...
if SERVER then
    ...
    function TRAIN_SYSTEM:Think(dT)
        ...
        Train:SetNW2Bool("RouteNumberLastStationWork",Work and Train.Battery.Voltage > 55)
